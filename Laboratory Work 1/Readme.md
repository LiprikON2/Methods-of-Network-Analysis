...
В итоге в обрезанной версии "B" группы, получилось 5000 нод и 64068 связей

Связями брались дружба пользователей группы, для их нахождения делался запрос для получения всех друзей каждого пользователя, и далее сравнивался с участниками группы

В процессе был превышен лимит на общее количество запросов
